...
def add_default_news(db):
    ...
    news_items = [
        ...
        News(
            category_id=1,  # IT/개발
            title="클라우드 네이티브 개발자 수요 급증...연봉 20~30% 더 높아",
            contents="클라우드 네이티브 개발자에 대한 수요가 급증하고 있다. 최근 국내 주요 IT 기업들이 클라우드 네이티브 개발자를 대규모로 채용하고 있다. 특히 쿠버네티스, 도커 등 클라우드 네이티브 기술에 대한 전문성을 갖춘 개발자들의 연봉이 일반 개발자보다 20~30% 높은 것으로 나타났다. IT업계 관계자는 '클라우드 네이티브 기술은 기업의 디지털 전환 과정에서 필수적인 요소로 자리잡고 있다'며 '이에 따라 관련 기술을 보유한 개발자에 대한 수요가 크게 증가하고 있다'고 설명했다. 실제로 최근 3개월간 국내 주요 구인구직 플랫폼에서 클라우드 네이티브 관련 채용 공고가 전년 동기 대비 45% 증가한 것으로 나타났다.",
            source="전자신문",
            publish_date=datetime.datetime(2024, 1, 16, 9, 45),
            category="IT/개발",
            url="https://n.news.naver.com/article/030/0003120000"
        ),
        News(
            category_id=2,  # 마케팅
        ...
        News(
            category_id=2,  # 마케팅
            title="'안다행' 장혁 '아직도 손톱이 파래'…맹추위에도 왕족대 낚시",
            contents="맹추위도 막지 못한 '끝장혁'의 역대급 '왕졲대 낚시' 현장이 펼쳐진다. 24일 방송되는 MBC '안싸우면 다행이야'(연출 김명진, 이하 '안다행') 133회에서는 '안다행' 터줏대감 붐과 god 박준형, 배우 장혁의 '내손내잡'(내 손으로 내가 잡는다) 두 번째 이야기가 그려진다. 스튜디오에는 황제성을 비롯해 장혁, 박준형의 27년 절친 데니안 그리고 빌리 츠키가 함께한다. 이날 붐, 박준형, 장혁은 아침에 제작한 대형 수족관을 채우기 위해 '왕족대 해루질'에 도전한다. 3년 동안 스튜디오에서 눈여겨보았던 '왕족대 낚시'를 붐이 사전에 준비, 형들과 함께 도전한 것. 하지만 거듭되는 시도에도 이들의 족대에는 기대만큼 많은 물고기가 잡히지 않는다. 더불어 물속에서 더 무거워지는 '왕족대' 그물의 무게뿐만 아니라 낮은 수온 때문에 추위와도 싸워야 했다는 전언. 그 추위는 자혁이 물에서 나온 뒤 '아직도 손톱이 파랗다'고 말할 정도였다고 한다. 하지만 추위에도 '끝장혁'의 열정은 꺼지지 않는다. 생선을 향한 장혁의 열정적인 모습에 다 함께 힘을 짜내 '붐쭌짱' 구호를 외치며 '왕족대 낚시'에 계속 도전하는 세 사람. 이어 붐은 큰 거 한 방을 노리며 바닷물에 몸까지 던진다는데. 이를 본 촌장 안정환도 그의 생고생을 인정하며 박수를 친다고 해 기대를 더한다.",
            source="전자신문",
            publish_date=datetime.datetime(2023, 7, 24, 11, 8),
            category="마케팅",
            url="https://n.news.naver.com/article/030/0003120000"
        )
    ]
